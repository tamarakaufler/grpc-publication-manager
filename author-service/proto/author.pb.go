...
func (*Author) Descriptor() ([]byte, []int) {
	return fileDescriptor_author_f734fe74111c7fda, []int{0}
}
...
func (*Token) Descriptor() ([]byte, []int) {
	return fileDescriptor_author_f734fe74111c7fda, []int{1}
}
...
func (*EmptyResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_author_f734fe74111c7fda, []int{2}
}
...
func (*GetAllRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_author_f734fe74111c7fda, []int{3}
}
...
func (*Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_author_f734fe74111c7fda, []int{4}
}
...
func (*Error) Descriptor() ([]byte, []int) {
	return fileDescriptor_author_f734fe74111c7fda, []int{5}
}
...
type AuthorServiceClient interface {
	...
	GetAllAuthors(ctx context.Context, in *GetAllRequest, opts ...grpc.CallOption) (*Response, error)
...
func (c *authorServiceClient) GetAllAuthors(ctx context.Context, in *GetAllRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/publication.management.author.AuthorService/GetAllAuthors", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthorServiceServer interface {
	...
	GetAllAuthors(context.Context, *GetAllRequest) (*Response, error)
...
func _AuthorService_GetAllAuthors_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/publication.management.author.AuthorService/GetAllAuthors",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthorServiceServer).GetAllAuthors(ctx, req.(*GetAllRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func init() { proto.RegisterFile("proto/author.proto", fileDescriptor_author_f734fe74111c7fda) }

var fileDescriptor_author_f734fe74111c7fda = []byte{
	// 477 bytes of a gzipped FileDescriptorProto
	,
}
